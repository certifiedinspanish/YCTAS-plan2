...
async function main(){
  ...
  const [countries, cuesCountries, cuesCapitals, mapData, compareData, egData] = await Promise.all([
    loadJSON('countries.json?v=21'),
    loadJSON('cues_countries.json?v=21'),
    loadJSON('cues_capitals.json?v=21'),
    loadJSON('map.json?v=21'),
    loadJSON('compare.json?v=21'),
    loadJSON('eg_data.json?v=21'),
  ]);
