...
async function main(){
  ...
  const [countries, cuesCountries, cuesCapitals, mapData, compareData, egData] = await Promise.all([
    loadJSON('countries.json?v=36'),
    loadJSON('cues_countries.json?v=36'),
    loadJSON('cues_capitals.json?v=36'),
    loadJSON('map.json?v=36'),
    loadJSON('compare.json?v=36'),
    loadJSON('eg_data.json?v=36'),
  ]);
