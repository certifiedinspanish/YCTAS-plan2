...
async function main(){
  ...
  const [countries, cuesCountries, cuesCapitals, mapData, compareData, egData] = await Promise.all([
    loadJSON('countries.json?v=34'),
    loadJSON('cues_countries.json?v=34'),
    loadJSON('cues_capitals.json?v=34'),
    loadJSON('map.json?v=34'),
    loadJSON('compare.json?v=34'),
    loadJSON('eg_data.json?v=34'),
  ]);
