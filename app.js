...
async function main(){
  ...
  const [countries, cuesCountries, cuesCapitals, mapData, compareData, egData] = await Promise.all([
    loadJSON('countries.json?v=32'),
    loadJSON('cues_countries.json?v=32'),
    loadJSON('cues_capitals.json?v=32'),
    loadJSON('map.json?v=32'),
    loadJSON('compare.json?v=32'),
    loadJSON('eg_data.json?v=32'),
  ]);
